...
\begin{DoxyCode}{0}
\DoxyCodeLine{00101 \{}
\DoxyCodeLine{00102   \textcolor{keywordtype}{char} httpRequestMethod[\mbox{\hyperlink{http-handler_8h_a49180fdd018be2adfe4df3a59482ab0c}{HTTP\_REQUEST\_METHOD\_LEN}}] = \{ 0 \};}
\DoxyCodeLine{00103   \textcolor{keywordtype}{char} httpRequestPath[\mbox{\hyperlink{http-handler_8h_a7d0073152dc4351d8b645031b83093d0}{HTTP\_REQUEST\_PATH\_LEN}}] = \{ 0 \};}
\DoxyCodeLine{00104   \textcolor{keywordtype}{char} httpRequestVersion[\mbox{\hyperlink{http-handler_8h_a158d838bff67042768ab941e496265c5}{HTTP\_REQUEST\_VERSION\_LEN}}] = \{ 0 \};}
\DoxyCodeLine{00105 }
\DoxyCodeLine{00106   \textcolor{keywordtype}{int} httpParseStatus = parseHTTPRequest(receiveMessageSize,}
\DoxyCodeLine{00107                                          receiveMessage,}
\DoxyCodeLine{00108                                          httpRequestMethod,}
\DoxyCodeLine{00109                                          httpRequestPath,}
\DoxyCodeLine{00110                                          httpRequestVersion,}
\DoxyCodeLine{00111                                          \textcolor{stringliteral}{"{} "{}});}
\DoxyCodeLine{00112   \textcolor{keywordflow}{if} (httpParseStatus == -\/1 ) \{}
\DoxyCodeLine{00113     fprintf(stderr, \textcolor{stringliteral}{"{}web-\/server: Failed to parse HTTP request header\(\backslash\)n"{}});}
\DoxyCodeLine{00114     fprintf(stderr, \textcolor{stringliteral}{"{}web-\/server: Received HTTP request as follows:\(\backslash\)n\%s"{}},}
\DoxyCodeLine{00115             receiveMessage);}
\DoxyCodeLine{00116     \textcolor{keywordflow}{return} -\/1;  \textcolor{comment}{/* Failure */}}
\DoxyCodeLine{00117   \}}
\DoxyCodeLine{00118 }
\DoxyCodeLine{00119   \textcolor{keywordtype}{int} httpRequestMethodHandler = -\/1;}
\DoxyCodeLine{00120   \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i <= PATCH; i++)}
\DoxyCodeLine{00121     \textcolor{keywordflow}{if} (strcmp(httpRequestMethod, httpMethodStr[i]) == 0)}
\DoxyCodeLine{00122       httpRequestMethodHandler = i;}
\DoxyCodeLine{00123 }
\DoxyCodeLine{00124   \textcolor{keywordflow}{switch} (httpRequestMethodHandler) \{}
\DoxyCodeLine{00125     \textcolor{keywordflow}{case} GET:}
\DoxyCodeLine{00126       \textcolor{keywordflow}{if} (createHTTPResponseMessage(responseMessageSize, responseMessage, OK) == -\/1)}
\DoxyCodeLine{00127         \textcolor{keywordflow}{return} -\/1;  \textcolor{comment}{/* Failure */}}
\DoxyCodeLine{00128       \textcolor{keywordflow}{break};}
\DoxyCodeLine{00129     \textcolor{keywordflow}{case} HEAD:}
\DoxyCodeLine{00130     \textcolor{keywordflow}{case} POST:}
\DoxyCodeLine{00131     \textcolor{keywordflow}{case} PUT:}
\DoxyCodeLine{00132     \textcolor{keywordflow}{case} DELETE:}
\DoxyCodeLine{00133     \textcolor{keywordflow}{case} CONNECT:}
\DoxyCodeLine{00134     \textcolor{keywordflow}{case} OPTIONS:}
\DoxyCodeLine{00135     \textcolor{keywordflow}{case} TRACE:}
\DoxyCodeLine{00136     \textcolor{keywordflow}{case} PATCH:}
\DoxyCodeLine{00137       \textcolor{keywordflow}{if} (createHTTPResponseMessage(responseMessageSize, responseMessage, METHOD\_NOT\_ALLOWED) == -\/1)}
\DoxyCodeLine{00138         \textcolor{keywordflow}{return} -\/1;  \textcolor{comment}{/* Failure */}}
\DoxyCodeLine{00139       \textcolor{keywordflow}{break};}
\DoxyCodeLine{00140     \textcolor{keywordflow}{default}:}
\DoxyCodeLine{00141       \textcolor{keywordflow}{if} (createHTTPResponseMessage(responseMessageSize, responseMessage, NOT\_IMPLEMENTED) == -\/1)}
\DoxyCodeLine{00142         \textcolor{keywordflow}{return} -\/1;  \textcolor{comment}{/* Failure */}}
\DoxyCodeLine{00143       \textcolor{keywordflow}{break};}
\DoxyCodeLine{00144   \};}
\DoxyCodeLine{00145 }
\DoxyCodeLine{00146   \textcolor{keywordflow}{return} 0; \textcolor{comment}{/* Success */}}
\DoxyCodeLine{00147 \};}
